...
@ImmersedAction(actionId = "CAPITAL_STRIP_AT_SPLICE_ACTION",
		label = "Convert to center stripped",
		tooltip = "Convert to center stripped",
		icon = "ico_strip_at_splice_active",
		buttonStyle = "SMALL_IMAGE_AND_TEXT")
public class StripAtSpliceActionUI extends ActionUI
{

	public StripAtSpliceActionUI(ICaplet caplet)
	{
		super(caplet);
	}
	...
	public void setupUI()
	{
		...
		putValue(NAME, ResourceMgr.getString(StripAtSpliceActionUI.class, "StripAtSpliceActionUI.name.decl"));
		putValue(SHORT_DESCRIPTION,
				ResourceMgr.getString(StripAtSpliceActionUI.class, "StripAtSpliceActionUI.name.decl"));
		putValue(LONG_DESCRIPTION,
				ResourceMgr.getString(StripAtSpliceActionUI.class, "StripAtSpliceActionUI.longDesc.decl"));
	...
	{
		return StripAtSpliceAction.class.getName();
	}
}

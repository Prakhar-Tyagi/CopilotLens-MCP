...
/**
 * Overrides {@link CreatePlugConnectorAction} to not add pins by default.
 *
 * @author Matt Boyd
 */
public class CreateNoPinPlugConnectorAction extends CreatePlugConnectorAction
{

	private ILibraryPartSelection m_librarySelection;
	private static Cursor m_cursor = null;

	public CreateNoPinPlugConnectorAction(ICapletController controller)
	{
		super(controller);
		if (m_cursor == null) {
			m_cursor = CAFUtils.getInstance()
					.loadCursor(controller.getCaplet(), "chs/images/app/cur_connector_nopin.gif", new Point(7, 7));
		}
	}
	...
	public IActionEnum onActivate(ActionEvent e)
	{
		...
		if (m_librarySelection != null &&
			...
			IConnector connector = cblFactory.createPlugConnector(uid);
	...
	{
		return CreateNoPinPlugConnectorActionUI.class.getName();
	}

 ...
 */
public abstract class CreateLayoutComponentOnlyWithPartFromPartBrowserAction extends PartBrowserAction
{

	protected CreateLayoutComponentOnlyWithPartFromPartBrowserAction(
	...
	public IAction getActionToPerform()
	{
		return CAFUtils.getInstance().getActiveCapletController()
				.getAction(CreateOtherComponentOnlyWithPartAction.class);
	}
}

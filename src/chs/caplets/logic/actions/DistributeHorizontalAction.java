...
/**
 * Created by IntelliJ IDEA. User: lstamper Date: Aug 2, 2004 Time: 1:15:02 PM
 */
public class DistributeHorizontalAction extends AbstractPlacementAction
{

	public DistributeHorizontalAction(ICapletController controller)
	{
		super(controller);
	}
	...
	{
		return DistributeHorizontalActionUI.class.getName();
	}
}

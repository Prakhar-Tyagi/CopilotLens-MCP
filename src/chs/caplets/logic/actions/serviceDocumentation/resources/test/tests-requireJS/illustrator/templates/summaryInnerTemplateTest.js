 ...
 * Copyright 2021 Siemens
 */
describe("summaryInnerTemplateTest", function ()
{
    var golden = '';
    beforeEach(function ()
    {
    ...
    it("should be able to load summary inner  template", function ()
    {
        var templateLoaded = false;
        $.ajax("/base/s/illustrator/templates/summary-inner.html", {async: false}).done(
                function (html)
                {
                    templateLoaded = true;
                    ...
                    expect(compiledTemplate.indexOf('<table class="grid-ui summary-inner">') >= 0).toBeTruthy();

...
require(["ReportsPopoverModel"], function (popoverModel) {

    describe("ReportsPopoverModelTest", function () {
        it("should set the dimensions correctly", function () {
            var x = 10, y = 20;
            mentor.publisher.eventDispatcher.dispatchEvent(mentor.publisher.events.SHOW_REPORTS_POPUP,
                {x : x || x, y : y || y});

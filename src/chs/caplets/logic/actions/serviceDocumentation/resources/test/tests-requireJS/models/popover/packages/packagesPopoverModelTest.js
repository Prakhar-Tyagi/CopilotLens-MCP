...
require(["PackagesPopoverModel"], function (popoverModel) {

    describe("PackagesPopoverModelTest", function () {
        it("should set the dimensions correctly", function () {
            var x = 10, y = 20;
            mentor.publisher.eventDispatcher.dispatchEvent(mentor.publisher.events.OPEN_PACKAGES_POPUP,
                {x : x || x, y : y || y});

...
require(["RelatedDataPopoverModel"], function (popoverModel) {

    describe("RelatedDataPopoverModelTest", function () {
        it("should set the dimensions correctly", function () {
            var x = 10, y = 20;
            mentor.publisher.eventDispatcher.dispatchEvent(mentor.publisher.events.SHOW_RELATED_DATA_POPUP,
                {x : x || x, y : y || y});

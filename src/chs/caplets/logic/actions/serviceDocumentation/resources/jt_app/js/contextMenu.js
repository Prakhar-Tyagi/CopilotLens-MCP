...
function enableContextMenu () {
	...
	document.getElementById( 'plmviswebHost' ).addEventListener( 'contextmenu', handleContextClick, true );
	document.getElementById( 'plmviswebHost' ).addEventListener( 'click', onClick, true );
    ...
    document.getElementById('plmviswebHost').addEventListener('touchstart', touchStartHandler, true);
    document.getElementById('plmviswebHost').addEventListener('touchend', touchEndHandler, true);
    document.getElementById('plmviswebHost').addEventListener('touchmove', touchMoveHandler, true);
    //document.getElementById( 'plmviswebHost' ).addEventListener( 'touchcancel', stopDefault, true );

    // disable user-selection in the content area
    var userSelectionDisabled = '; user-select: none; -webkit-user-select: none;';
    var containerIds = ['plmviswebHost', 'content', 'contextMenu'];

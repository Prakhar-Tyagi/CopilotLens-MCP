        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                ...
                <fo:simple-page-master master-name="landscape"
                    ...
                    <fo:region-start region-name="start-normal" extent="0mm"/>
                    <!-- defines the region-end which is the area to the rigth of the body-->
                    <fo:region-end region-name="end-normal" extent="0mm"/>
            ...
            <fo:page-sequence master-reference="landscape">
                <fo:static-content flow-name="header-normal">
                    ...
                    <!--The header string defined for the generator in the pdfConfiguration.xml is shown here-->
                ...
                <fo:static-content flow-name="start-normal">
                    ...
                    <!--The start string defined for the generator in the pdfConfiguration.xml is shown here-->
                    <fo:block text-align="center" font-family="customfont,Helvetica">
                ...
                <fo:static-content flow-name="end-normal">
                    ...
                    <!--The end string defined for the generator in the pdfConfiguration.xml is shown here-->
                    <fo:block text-align="center" font-family="customfont,Helvetica">

...
public class CreateNewLogicDesignDelegate extends CreateNewDesignDelegate
{

	public CreateNewLogicDesignDelegate(@NotNull ILifeCycleChangeListener lifeCycleListener,
	...
	{
		return new OpenLogicDiagramDelegateForNewDesign(mLifeCycleListener, mCaplet, getResourceClass(), mDesignTagXML,
